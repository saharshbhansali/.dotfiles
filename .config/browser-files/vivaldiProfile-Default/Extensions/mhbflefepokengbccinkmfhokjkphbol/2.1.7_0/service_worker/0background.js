...
chrome.webRequest.onCompleted.addListener(
  async (details) => {
    ...
    else if (link.indexOf("vtop/assets/img/favicon.ico") !== -1 || link.indexOf("menu.js") !== -1 || link.indexOf("home") !== -1) {
